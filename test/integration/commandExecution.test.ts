...
describe('Command Execution Integration Tests', () => {
  ...
  describe('Complex scenarios', () => {
    ...
    it('should handle file removal with options', () => {
      ...
      const hasTestDir = output.some(segment => 
        segment.text && segment.text.includes('testdir')
      )
    ...
    it('should handle markdown file rendering', () => {
      ...
      const hasMarkdownFormatting = segments.some(segment => 
        segment.type === 'header-1' || segment.type === 'bold' || segment.type === 'code-block'
      )
    ...
    it('should handle easter egg discovery', () => {
      ...
      let hasSecret = output.some(segment => 
